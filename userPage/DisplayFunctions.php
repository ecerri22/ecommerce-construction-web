    ...
    <header class="">
        <div class="header-container">
            ...
            <div class="lower-bar">
                <ul class="tabs-list">
                    <li>
                        <a href="#" class="tab-link tab-link-active"onclick="changefocus(this)">Home</a>
                    </li>
                    <li>
                        <a href="#" class="tab-link" onclick="changefocus(this)">Products</a>
                    </li>
                    <li>
                        <a href="#" class="tab-link" onclick="changefocus(this)">About Us</a>
                    </li>
                    <li>
