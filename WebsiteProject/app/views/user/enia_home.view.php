...
<head>
    ...
    <link rel="stylesheet" href="/public/Enia/eniaStyles.css" />
        ...
        <div class="our-story">
            <div class="left-img">
                <div class="composition">
                    <img src="/public/image/worker.jpg" alt="construction worker" class="composition-photo composition-photo-1">
                    <img src="/public/image/construction-workers.jpg" alt="construction workers" class="composition-photo composition-photo-2">
                </div>
            </div>
        ...
        <div class="featured-products">
            ...
            <div class="featured-products-list">               
                <div class="featured-product-container">
                    <img class="product-img" src="/public/image/Tools Market_Vidues gipsi me bateri.jpg" alt="Tool">
                    <a href="#">Tool Tool Tool</a>
                    <p>$14.99</p>
                </div>

                <div class="featured-product-container">
                    <img class="product-img" src="/public/image/KEAD_Sharre bango me disk 240V 2000W Worcraft MST20-255.jpg" alt="Tool">
                    <a href="#">Tool Tool Tool</a>
                    <p>$14.99</p>
                </div>

                <div class="featured-product-container">
                    <img class="product-img" src="/public/image/Albaelettrica_Sharre me disk Milwaukee.jpg" alt="Tool">
                    <a href="#">Tool Tool Tool</a>
                    <p>$14.99</p>
                </div>
            </div>
