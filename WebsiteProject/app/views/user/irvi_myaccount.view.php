...
<head>
    ...
    <script src="/public/Irvi/editAccount.js"></script>
    <!-- <link rel="stylesheet" href="style.css"> -->
    <link rel="stylesheet" href = "/public/Irvi/editAccount.css">
                ...
                <div class="col-xl-8" id = "accountDetailsCard">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <div class="row ">
                                <div class="col-xl-10">Account Details</div> 
                                <button id="editProfileButton" class="btn btn-secondary col-md-1 col-xl-2 mb-0 p-0 edit-profile-btn" type="button"> Edit Profile</button>
                            </div>
