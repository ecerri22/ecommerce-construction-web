                ...
                <form class="formSignUp" method="post" action="/signup">
                    <div class="first-last-name">
                        <div class="input-field">
                            ...
                            <input class="login-input" type="text" name="fname" class="input-form" placeholder="Enter your first name" />
                        </div>
                        <div class="input-field">
                            <label for="lname"class="labels">last name</label>
                            <input class="login-input"type="text" name="lname" class="input-form" placeholder="Enter your last name"/>
                        </div>
                    </div>
                    <div class="input-field">
                        <label for="email"class="labels">email</label>
                        <input class="login-input" type="text" name="email"class="input-form" placeholder="Enter your email">
                    </div>
                    <div class="input-field">
                        <label for="pass"class="labels">password</label>
                        <input class="login-input" type="password" name="pass" class="input-form" placeholder="Enter the password">
                    </div>
